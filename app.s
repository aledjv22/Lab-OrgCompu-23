...
auto :
    ...
    //sobra
    movz x10, 0xE1, lsl 16 // Color negro parte 1
    movk x10, 0xE1E1, lsl 00 // Color negro parte 2
    mov x15, 325 // PY (posición Y)
    ...
    //parabrisas
    movz x10, 0x57, lsl 16 // Color gris parte 1
    movk x10, 0x5757, lsl 00 // Color gris parte 2
    mov x15, 395
    mov x17, 190
    mov x4, 18
    bl circulo
    ...
    mov x15, 365 // PY (posición Y)
    mov x17, 170 // PX (posición X)
    mov x16, 399 // FY (fin Y)
    mov x18, 210 // FX (fin X)
    bl rectangulo 
